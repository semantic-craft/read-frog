...
import { withFirefoxFix } from '@/utils/firefox/firefox-baseui'
import { cn } from '@/utils/styles/utils'

function DropdownMenu({ onOpenChange, ...props }: React.ComponentProps<typeof MenuPrimitive.Root>) {
  return (
    <MenuPrimitive.Root
      data-slot="dropdown-menu"
      onOpenChange={withFirefoxFix(onOpenChange)}
      {...props}
    />
  )
}
