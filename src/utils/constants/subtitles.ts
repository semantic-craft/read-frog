...
// Streaming subtitles
export const STREAMING_SUBTITLE_TRACKS_TYPE = "READ_FROG_STREAMING_SUBTITLE_TRACKS"
export const STREAMING_SUBTITLE_CAPTURED_TYPE = "READ_FROG_STREAMING_SUBTITLE_CAPTURED"
export const STREAMING_ENSURE_NATIVE_SUBTITLES_TYPE = "READ_FROG_STREAMING_ENSURE_NATIVE_SUBTITLES"
export const STREAMING_LIVE_CAPTURE_START_TYPE = "READ_FROG_STREAMING_LIVE_CAPTURE_START"
export const STREAMING_LIVE_CAPTURE_STOP_TYPE = "READ_FROG_STREAMING_LIVE_CAPTURE_STOP"
export const STREAMING_LIVE_CAPTURE_CUE_TYPE = "READ_FROG_STREAMING_LIVE_CAPTURE_CUE"
export const STREAMING_SUBTITLE_WAIT_TIMEOUT_MS = 10_000
export const STREAMING_NATIVE_SUBTITLES_SELECTOR = ".player-timedtext, .player-timedtext-text-container, [data-uia='player-timedtext']"
