...
Ever watched your API credits vanish while translating a long article? Hit a "rate limit exceeded" error mid-paragraph?

We've got something exciting for you.

{/* TODO: Add hero image - Batch translation dashboard showing cost savings comparison */}

We're launching two game-changers: **Beta Experience** (your VIP pass to new features) and **Batch Translation** (your API budget's new best friend).
...
{/* TODO: Add screenshot - Beta Experience toggle in settings with features list */}
...
- 💸 **20x the cost** - your credits drain fast
...
{/* TODO: Add diagram - Visual showing 20 individual requests vs 4 batched requests */}
...
{/* TODO: Add screenshot - Settings page showing Beta Experience toggle and Batch Translation configuration */}
...
2. ✅ Turn on **Batch Translation**
3. ✅ Start saving 60-80% on every translation

**Note**: Batch Translation is currently in beta. Encounter any issues? [Let us know](https://discord.gg/ej45e3PezJ) so we can make it even better!

{/* TODO: Add image - Success metrics dashboard showing cost savings over time */}
