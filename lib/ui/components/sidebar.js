...
function SidebarTrigger({ className, onClick,...props }) {
	...
	return /* @__PURE__ */ jsxs(Button, {
		...
		...props,
		children: [open ? /* @__PURE__ */ jsx(IconLayoutSidebarRightExpand, { className: "size-full" }) : /* @__PURE__ */ jsx(IconLayoutSidebarLeftExpand, { className: "size-full" }), /* @__PURE__ */ jsx("span", {
			className: "sr-only",
